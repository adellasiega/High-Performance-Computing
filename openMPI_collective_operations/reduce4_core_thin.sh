...
do
    ...
    do
        ...
        result=$(mpirun --map-by sockets -np $procs --mca coll_tuned_use_dynamic_rules true --mca coll_tuned_reduce_algorithm 4 osu_reduce -m $size -x $reps -i $reps | tail -n 1 | awk '{print $2}')
